<?php 
    ...
    $sql="SELECT *  FROM pais_extranjero";
    $query=mysqli_query($con,$sql);
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <title> PAISES EXTRANJEROS </title>
        <meta charset="UTF-8">
    ...
    <body>
            <div class="container mt-5" style="padding-top:50px"> 
                    <div class="row"> 
                        ...
                        <div class="col-md-3">
                            <h1>Ingrese datos</h1>
                                <form action="paisE/insertar.php" method="POST">

                                    <input type="text" class="form-control mb-3" name="id" placeholder="IdPaisExtranjero" required="required">
                                    <input type="text" class="form-control mb-3" name="nombre" placeholder="Nombre" required="required">
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th><a href="paisE/actualizar.php?id=<?php echo $row['id'] ?>" class="btn btn-info">Editar</a></th>
                                                <th><a href="paisE/delete.php?id=<?php echo $row['id'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                            </tr>
                                        <?php 
                                            }
                                        ?>

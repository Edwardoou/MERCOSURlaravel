...
<div class="container mt-5" style="padding-top:50px">
                    <div class="row"> 
                    <a href="{{ route('paisE.create') }}" class="btn btn-info" >Añadir Paises extranjeros</a>
                        <div class="col-md-12">
                        <br>
                        <table class="table text-center bg-white" >
                                <thead class="table-success table-striped" >
                                    <tr>
                                        <th>IdPaisextranjeros</th>
                                        <th>Nombre</th>
                        ...
                        <td><a class="btn btn-warning " href="{{action('PaisEController@edit', $extr->id)}}" >Editar</a></td>


                        <td>
                        <form action="{{action('PaisEController@destroy', $extr->id)}}" method="post">
                        @csrf

...
<div class="container mt-5" style="padding-top:50px">
                    <div class="row"> 
 <a href="{{ route('comercial.create') }}" class="btn btn-info" >Añadir Relaciónes Comerciales</a>
 <div class="col-md-12">
 <br>
 ...
 <tbody>
 @if($comercial->count())
 @foreach($comercial as $com)
 <tr>
 <td>{{$com->id}}</td>
 <td>{{$com->pais_miembro_nombre}}</td>
 <td>{{$com->tipo}}</td>
 <td>{{$com->pais_extranjero_nombre}}</td>
 <td>{{$com->porcentaje}}</td>
 <td><a class="btn btn-warning btn-xs" href="{{action('ComercialController@edit', $com->id)}}" >Editar</a></td>


 <td>
 <form action="{{action('ComercialController@destroy', $com->id)}}" method="post">
 @csrf
